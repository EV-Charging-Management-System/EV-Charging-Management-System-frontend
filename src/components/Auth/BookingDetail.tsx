...
import { FaPhoneAlt, FaBolt, FaCheckCircle } from "react-icons/fa";
...
const BookingDetail: React.FC = () => {
  ...
  const currentStation =
    stationList.find((s) => s.id === stationId)?.name || "Không xác định";
    ...
    <div className="booking-container">
      ...
      <nav className="menu-bar">
        <ul className="menu-list">
          ...
          <li className="menu-active">Booking Detail</li>
            ...
            {!selectedStation ? (
              ...
              <div className="payment-success">
                ...
                <div className="success-info">
                  ...
                  <p>
                    <strong>Cổng:</strong>{" "}
                    {stations[selectedStation - 1]?.port} –{" "}
              ...
              <form className="booking-form" onSubmit={handleSubmit}>
                ...
                <p className="station-info">
                  {currentStation} –{" "}
                  {stations[selectedStation - 1]?.port || "Cổng không xác định"}
                </p>
                ...
                <div className="form-inline">
                  <div>
                    ...
                    <input
                      type="text"
                      value={stations[selectedStation - 1]?.port || ""}
                      readOnly
                    />
                  </div>
                  <div>
                    ...
                    <input
                      type="text"
                      value={stations[selectedStation - 1]?.power || ""}
                      readOnly
                    />
                  </div>
                </div>
        ...
        <section className="station-grid">
          ...
          <div className="grid-container">
            {stations.map((s) => (
              <div
                key={s.id}
                className={`station-box ${s.status} ${
                  selectedStation === s.id ? "active" : ""
                }`}
                onClick={() =>
                  s.status === "available" ? setSelectedStation(s.id) : null
                }
              >
                <h4>#{s.id}</h4>
