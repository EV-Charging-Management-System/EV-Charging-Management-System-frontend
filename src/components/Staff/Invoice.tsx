        ...
        <div className="charging-sidebar">
          ...
          <nav className="charging-menu">
            <ul>
              ...
              <li className="active" onClick={() => navigate("/staff/invoice")}>
                Invoice
              </li>
          ...
          <div className="invoice-container">
            ...
            {invoice ? (
              <>
                ...
                {!paid ? (
                  <>
                    <h3 className="choose-method-title">
                  ...
                  <div className="payment-success">
                    ...
                    <button onClick={() => navigate("/staff/sessions")}>
                      🔙 Quay lại phiên sạc
                    </button>
                  </div>
                )}
